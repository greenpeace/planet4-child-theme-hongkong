...
function donation(Swiper) {
  ...
  // $('.en__component.en__component--formblock').wrapAll(
  //   '<div class="swiper-container maxi-swiper maxi-swiper-centered cards-swiper"><div class="swiper-wrapper"></div></div>'
  // );
  /*
