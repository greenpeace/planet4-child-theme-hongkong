  ...
  function connectDonationTabs() {
    document.querySelectorAll('.js-tab-item').forEach(tab => {
      tab.addEventListener('click', e => {
        ...
        const handles = tabBar.parentElement.querySelectorAll(
          '.dollar-handles'
        );
  ...
  function connectToggles() {
    document.querySelectorAll('.toggle').forEach(toggle => {
      toggle.addEventListener('click', e => {
        ...
        const toggleeHeight = togglee.children[0].getBoundingClientRect()
          .height;
  ...
  function connectENForm() {
    ...
    if (checkboxCheckall) {
      checkboxCheckall.addEventListener('click', e => {
        ...
        for (
          var i = 0, elementOption;
          (elementOption = privacyOptions[i++]);
