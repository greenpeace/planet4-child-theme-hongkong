...
class P4CT_Site {
	...
	protected function hooks() {
		...
		add_action( 'cmb2_admin_init', [ $this, 'register_sidebar_metabox_child' ] );
		add_action( 'cmb2_admin_init', [ $this, 'gpea_register_main_options_metabox' ] );
	 ...
	 */
	public function gpea_register_main_options_metabox() {
